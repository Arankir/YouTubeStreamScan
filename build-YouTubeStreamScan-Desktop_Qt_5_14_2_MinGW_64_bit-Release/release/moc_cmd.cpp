...
#include <memory>
#include "../../YouTubeStreamScan/cmd.h"
...
QT_MOC_LITERAL(1, 4, 10), // "s_closeApp"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 8) // "closeApp"

    },
    "Cmd\0s_closeApp\0\0closeApp"
};
...
void Cmd::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Cmd::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cmd::s_closeApp)) {
                *result = 0;
                return;
            }
        }
